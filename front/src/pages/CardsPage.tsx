...
import { Box, Heading, Text, Button, HStack, Center, Spinner, Icon, Flex } from "@chakra-ui/react";
    ...
    <Center py={10}>
      <Box w="100%" maxW="900px" bg="white" borderRadius="2xl" boxShadow="lg" borderWidth="1px" p={8}>
        ...
        <HStack justify="space-between" mt={8}>
          ...
          <Button onClick={next} isDisabled={index === cards.length - 1} variant="outline">
