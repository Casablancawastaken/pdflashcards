def build_cards_prompt(text: str, max_cards: int = 7) -> str:
    return f"""
ВНИМАНИЕ — ПРОЧИТАЙ ВНИМАТЕЛЬНО:
Ты — помощник, который создаёт учебные флеш-карточки строго по тексту.

ПРАВИЛО ЯЗЫКА:
- Если входной текст на русском → вопросы и ответы должны быть ТОЛЬКО НА РУССКОМ.
- Если входной текст на английском → вопросы и ответы должны быть ТОЛЬКО НА АНГЛИЙСКОМ.
